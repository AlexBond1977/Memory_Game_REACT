...
class Card extends React.Component {
    ...
    // переносим в родительский компонент при реализации функционала сверки совпадений карточек и
    // удаляем конструктор
    // constructor() {
    //     super();
    ...
    cardClickHandler(item) {
        // позже добавляем использование props родительского компонента и везде ниже
